...
HYPH_COMPOUNDS = '../data/tests/hyph-compounds.txt'
HYPH_DERIVATIONS = '../data/tests/hyph-derivations.txt'
HYPH_INFLECTIONS = '../data/tests/hyph-inflections.txt'

class TestAll

    def initialize
        @complex    = read_test_data(HYPH_INFLECTIONS)
        @dict = Dictionary.new
